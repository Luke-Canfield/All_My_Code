...
*/
	//Test 1 for delete_key 
    printf("Test for deleting many nodes\n");
	...
	/*bool success_6 = delete_key(&root, 736); 
	bool success_7 = delete_key(&root, 902); 
	bool success_8 = delete_key(&root, 972); 
	bool success_9 = delete_key(&root, 984); 
	printf(success ? "Successful Deletion\n" : "Key didn't exist\n");
	assert_node_correct(root);
	printf(success_1 ? "Successful Deletion\n" : "Key didn't exist\n");
	assert_node_correct(root);
	...
	assert_node_correct(root);
	printf(success_9 ? "Successful Deletion\n" : "Key didn't exist\n");
	assert_node_correct(root);
	*/
	assert_node_correct(root);
	print_btree(root);

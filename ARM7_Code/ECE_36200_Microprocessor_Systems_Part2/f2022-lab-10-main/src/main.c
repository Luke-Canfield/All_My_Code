...
#define LCD
  ...
  LCD_DrawRectangle(50, 70, 100, 80, 124);
  LCD_DrawRectangle(40, 60, 300, 400, 90);
  LCD_DrawRectangle(120, 50, 70, 10, 200);
  LCD_DrawRectangle(4, 67, 135, 185, 80);
  LCD_DrawRectangle(12, 60, 40, 29, 30);
  LCD_DrawRectangle(50, 20, 250, 140, 150);
  LCD_DrawRectangle(0, 200, 100, 40, 20);
  LCD_Circle(20, 10, 30, 1, 23);
  LCD_Circle(5, 90, 30, 0, 150);
  LCD_DrawTriangle(45, 45, 100, 100, 75, 75, 255);

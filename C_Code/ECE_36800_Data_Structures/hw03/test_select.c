...
int main(int argc, char* argv[]) {
	...
	size_t num_numbers_good_partition = sizeof numbers_good_partition 
	                                  / sizeof numbers_good_partition[0];
	...
	size_t num_numbers_bad_partition_1 = sizeof numbers_bad_partition_1 
	                                   / sizeof numbers_bad_partition_1[0];
	...
	size_t num_numbers_bad_partition_2 = sizeof numbers_bad_partition_2
	                                   / sizeof numbers_bad_partition_2[0];
	...
	assert(test_get_kth_smallest(0, TEST_NUMBERS_O_N, num_numbers));
	assert(test_get_kth_smallest(0, TEST_NUMBERS_O_N2, num_numbers)); 
	assert(test_get_kth_smallest(6, TEST_NUMBERS_O_N, num_numbers));
	assert(test_get_kth_smallest(6, TEST_NUMBERS_O_N2, num_numbers));
	assert(test_get_kth_smallest(12, TEST_NUMBERS_O_N, num_numbers));
	assert(test_get_kth_smallest(12, TEST_NUMBERS_O_N2, num_numbers));
	assert(test_get_kth_smallest(18, TEST_NUMBERS_O_N, num_numbers));
	assert(test_get_kth_smallest(18, TEST_NUMBERS_O_N2, num_numbers));
	print_success_msg("test_data_works");
